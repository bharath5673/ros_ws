                ...
                if (radius !=5):
                    ...
                    if(detected_sign.shape[1] and detected_sign.shape[0]):
                        ...
                        if write_data:
                            ...
                            img_dir = os.path.abspath("src/self_driving_car_pkg/self_driving_car_pkg/data/dataset_signs/datasets") + class_id
...
def detect_Signs(frame,frame_draw):
    ...
    if not model_loaded:
        ...
        # 1. Load CNN model
        global model
        model = load_model(os.path.join(os.getcwd(),"ros_ws/src/self_driving_car_pkg/self_driving_car_pkg/data/saved_model_Ros2_5_Sign.h5"),compile=False)
